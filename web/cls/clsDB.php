...
class clsDB
{
	 ...
	 */
	public function getRadioOptions($strFieldName, $arrOptions, $strChecked = '')
	{
		$arrCompleteOptions = array();
		foreach($arrOptions as $value=>$name)
		{
	...
	public static function getOptionsFromTable($strTableName, $strValueElement = 'name', $strKeyElement = 'id', $strZeroCaption = 'Please make a selection', $strOrderBy = 'id')
	{
		return clsDB::getOptionsFromList(clsDB::getListStatic($strTableName, '', $strOrderBy), $strValueElement, $strKeyElement, $strZeroCaption);
	}
